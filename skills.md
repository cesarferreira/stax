...
make release LEVEL=minor         # Minor release (same as default `make release`)
make release LEVEL=major         # Major release with hook-generated changelog notes
cargo release patch --dry-run    # Dry-run cargo release only; hook leaves CHANGELOG.md untouched
```
