...
### Fixed
- Align sweep cleanup with sync (#506)
- Respect pending PR rollup in ci watch (#507)

## [0.87.0] - 2026-06-16

### Added
- Add stack fast-forward merge (#502)

### Changed
- Treat st get branches as imported read-only bases (#501)

### Fixed
- Stabilize scripted TUI delays (#499)
...
### Changed
- Show remote indicator for pushed branches (#477)
...
### Fixed
- Resolved changes-requested reviews no longer block PRs (re-fix #376) (#469)
...
### Changed
- Add get command for remote branches (#449)
...
<!-- next-url -->
[Unreleased]: https://github.com/cesarferreira/stax/compare/v0.91.0...HEAD
[0.91.0]: https://github.com/cesarferreira/stax/compare/v0.90.0...v0.91.0
